...
public class SeleniumScenarioTest {
    ...
    public void test2_filter() {
        ...
        ExamAssert.assertEquals("by name only", 1, this.menuService.listMenuItemsByRestaurantNameAndMenuType("Restaurant 1", null).size());
        ...
        ExamAssert.assertEquals("by name and category", 1, this.menuService.listMenuItemsByRestaurantNameAndMenuType("Restaurant 1", MenuType.COOKIE).size());
        SubmissionHelper.endTest();
    }

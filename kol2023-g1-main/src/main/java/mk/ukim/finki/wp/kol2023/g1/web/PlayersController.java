...
//        }
        List<Player> players = this.playerService.listPlayersWithPointsLessThanAndPosition(pointsPerGame, position);
        model.addAttribute("players", players);
        model.addAttribute("positions", Arrays.stream(PlayerPosition.values()).toArray());
